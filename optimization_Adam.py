...
if __name__ == "__main__":
    ...
    files = ['./6_sigma_results/sample_shifted_500/000000.png',
             './6_sigma_results/sample_shifted_500/000001.png',
             './6_sigma_results/sample_shifted_500/000002.png',
             './6_sigma_results/sample_shifted_500/000003.png',
             './6_sigma_results/sample_shifted_500/000004.png']
    n_mean_latent = 10000
    ...
    if normalized:
        ...
        import numpy as np
        img = np.load('./projection_Test/true_image_data.npy')
        for i in range(5):
            img_tensor = img[i]
            imgs.append(img[i][0])
