...
if __name__ == "__main__":
    ...
    for shift in shifts:
        for disturbance in disturbances:
            ...
            fixed_sigma = 0.1
            args.save_dir = args.save_dir + "pixel_intensity/fixed_sigma_{}/shift_{}/disturbances_{}/".format(fixed_sigma,shift,disturbance).replace('.', '') # ToDO: DEL this part when publishing
            args.test_dir = args.test_dir + "fixed_sigma_{}/shift_{}/".format(fixed_sigma,shift).replace('.', '') # ToDO: DEL this part when publishing
