...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--steps", type=int, default=500, help="Number of optimization steps"
    )
    parser.add_argument(
    ...
    for iter in range(tests):
        ...
        alpha = alpha[0:optim.num_main_pc, :]+ 0.01*torch.randn((448,1)).to(optim.device) # solution for alpha = [448 x 1] tensor
